...
namespace BDInfo.Lib.BDROM
{
    ...
    {
        private readonly bool _enableSSIF;
        ...
        public TSStreamFile(FileInfo fileInfo, bool enableSSIF)
        {
            FileInfo = fileInfo;
            _enableSSIF = enableSSIF;
            DFileInfo = null;
            CdReader = null;
            ...
            bool extendedStreamDiagnostics)
        {
            ...
            switch (stream.StreamType)
            {
                ...
                case TSStreamType.HEVC_VIDEO:
                    TSCodecHEVC.Scan(
                        (TSVideoStream)stream, buffer, ref streamState.StreamTag, extendedStreamDiagnostics);
                    break;
        ...
        public void Scan(List<TSPlaylistFile> playlists, bool isFullScan, bool extendedStreamDiagnostics)
        {
