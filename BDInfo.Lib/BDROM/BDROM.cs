...
namespace BDInfo.Lib.BDROM
{
    public class BDROM
    {
        ...
        public readonly bool EnableSSIF;
        public readonly bool FilterLoopingPlaylists;
        public readonly bool FilterShortPlaylists;
        public readonly int FilterShortPlaylistsValue;
        public readonly bool KeepStreamOrder;
        public readonly bool ExtendedStreamDiagnostics;
        ...
        public BDROM(
            ...
            bool filterShortPlaylists,
            int filterShortPlaylistsValue,
            bool keepStreamOrder,
            bool extendedStreamDiagnostics)
        {
            EnableSSIF = enableSSIF;
            FilterLoopingPlaylists = filterLoopingPlaylists;

            FilterShortPlaylists = filterShortPlaylists;
            FilterShortPlaylistsValue = filterShortPlaylistsValue;
            KeepStreamOrder = keepStreamOrder;
            ExtendedStreamDiagnostics = extendedStreamDiagnostics;
            ...
            if (IsImage)
            {
                ...
                if (DiscDirectoryPLAYLIST != null)
                {
                    ...
                    {
                        PlaylistFiles.Add(file.Name.ToUpperInvariant(), new TSPlaylistFile(this, file, CdReader));
                    }
                }
                ...
                if (DiscDirectorySTREAM != null)
                {
                    ...
                    foreach (DiscFileInfo file in files)
                    {
                        StreamFiles.Add(file.Name.ToUpperInvariant(), new TSStreamFile(file, CdReader, EnableSSIF));
                    }
                }
                ...
                if (DiscDirectoryCLIPINF != null)
                {
                    ...
                    foreach (DiscFileInfo file in files)
                    {
                        StreamClipFiles.Add(file.Name.ToUpperInvariant(), new TSStreamClipFile(file, CdReader));
                    }
                }
                ...
                if (DiscDirectorySSIF != null)
                {
                    ...
                    foreach (DiscFileInfo file in files)
                    {
                        InterleavedFiles.Add(file.Name.ToUpperInvariant(), new TSInterleavedFile(file, CdReader));
                    }
                }
            }
            else
            {
                ...
                if (DirectoryPLAYLIST != null)
                {
                    ...
                    {
                        PlaylistFiles.Add(
                            file.Name.ToUpperInvariant(), new TSPlaylistFile(this, file));
                    }
                }
                ...
                if (DirectorySTREAM != null)
                {
                    ...
                    {
                        StreamFiles.Add(
                            file.Name.ToUpperInvariant(), new TSStreamFile(file, enableSSIF));
                    }
                }
                ...
                if (DirectoryCLIPINF != null)
                {
                    ...
                    {
                        StreamClipFiles.Add(
                            file.Name.ToUpperInvariant(), new TSStreamClipFile(file));
                    }
                }
                ...
                if (DirectorySSIF != null)
                {
                    ...
                    foreach (FileInfo file in files)
                    {
                        InterleavedFiles.Add(
                            file.Name.ToUpperInvariant(), new TSInterleavedFile(file));
                    }
                }
            }
        }
        ...
        public void Scan()
        {
            ...
            foreach (TSStreamFile streamFile in streamFiles)
            {
                try
                {
                    ...
                    streamFile.Scan(playlists, false, ExtendedStreamDiagnostics);
                }
                catch (Exception ex)
                {
        ...
        private long GetDirectorySize(DirectoryInfo directoryInfo)
        {
            ...
            {
                if (pathFile.Extension.ToUpperInvariant() == ".SSIF")
                {
                    continue;
                }
